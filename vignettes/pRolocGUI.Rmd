...
![The PCA Tab](figures/SS_01_map.png)
...
![Searching for proteins of interest](figures/SS_02_search.png)
...
![Brushing on the plot](figures/SS_03_brush.png)
![Zooming proteins of interest](figures/SS_04_zoom.png)
...
![Hiding the sidebars](figures/SS_05_nosidebars.png)
...
![The profiles tab](figures/SS_06a_ribbons.png)
![The profiles tab, selecting proteins of interest](figures/SS_06b_ribbons.png)
...
![Profiles faceted by subcellular class](figures/SS_07_facets.png)
...
![The compare application, main panel](figures/SS_12_compare.png)
...
```{r aggvar, echo = TRUE, message = FALSE, warning = FALSE}
## load PSM data
...
![The aggregate app](figures/SS_13_aggregate_mean.png)
...
![Examining peptides and proteins](figures/SS_14_aggregate_hl.png)
...
![the max function](figures/SS_15_aggregate_mean.png)
