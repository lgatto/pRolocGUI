...
align="center"> Fig. 2: Appearance of `PCA` tab for `pRolocVis` (`andy2011`)</p>
...
align="center"> Fig. 4: Appearance of PCA tab (`andy2011`). `markers`
...
align="center"> Fig. 5: Appearance of `protein profiles` tab in `pRolocVis`
...
align="center"> Fig. 6: Appearance of `quantitation` tab
...
align="center"> Fig. 7: Appearance of `feature meta-data` tab
(`andy2011`) in `pRolocVis`. Features shown originate from selection made in 
...
align="center"> Fig. 8: Appearance of `sample meta-data` tab
...
align="center"> Fig. 9: Appearance of `search` tab (`andy2011`) in `pRolocVis`. 
...
align="center"> Fig. 10: Appearance of `Data` tab in `pRolocVis` </p>
...
align="center">Fig. 12: Appearance of `Data` tab in `pRolocComp`. The row `ER` 
