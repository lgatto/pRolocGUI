...
in the drow-down list underneath (**_assigned to_**). To
display the next plot we have to change the slider **_Selected plot_**
to position 2. The shiny reactive expressions did not receive
yet a new input, therefore, we have to change the drop-down lists in 
order a new plot will be displayed. Accordingly to our question we will 
...
<p align="center"> Fig. 6: Appearance of protein profiles tab 
...
<p align="center"> Fig. 7: Appearance of quantitation tab (andy2011). Features shown
...
<p align="center"> Fig. 8: Appearance of feature meta-data tab (andy2011). Features shown
...
<p align="center"> Fig. 9: Appearance of sample meta-data tab (andy2011) </p>
...
<p align="center"> Fig. 10: Appearance of search tab (andy2011). Search result 
...
<p align="center"> Fig. 11: Display of selected features in PCA plot (andy2011). The features
...
<p align="center"> Fig. 12: Display of selected features in protein profiles plot. 
...
<p align="center"> Fig. 14: Query for proteins which contain the string "AC" which ycvb
