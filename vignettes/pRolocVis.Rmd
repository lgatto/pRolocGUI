...
Principal Component Analysis (PCA) plot for the selected `MSnSet` and
...
environment an object is internally created in `pRolocVis` which
...
When exiting `pRolocVis` these features will be assigned to the 
