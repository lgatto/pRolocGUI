...
<p> Fig. 1: Vignette of pRolocVis </p>
</div> 
...
<p> Fig. 2: Appearance of Data tab in pRolocVis </p>
</div> 
...
<p> Fig. 3: File upload in pRolocVis </p>
</div> 
...
<p> Fig. 4: Appearance of PCA tab (andy2011) </p>
</div>
...
<p> Fig. 5: Appearance of PCA tab (andy2011). markers used for colours, 
legend added. </p>
</div>
...
<p> Fig. 6: Appearance of protein profiles tab showing protein profiles  of
...
<div align="center">
<img src="figures/Screenshot_PP5.png" width="100%" alt="" />
<p> Fig. 7: Protein profiles of newly associated organelle groups according 
...
<p> Fig. 8: Appearance of quantitation tab (andy2011). Features shown
...
<p> Fig. 9: Appearance of feature meta-data tab (andy2011). Features shown
...
<p> Fig. 10: Appearance of sample meta-data tab (andy2011) </p>
</div>
...
<p> Fig. 11: Appearance of search tab (andy2011). Search result 
...
<p> Fig. 12: Display of selected features in PCA plot (andy2011). The features
...
<p> Fig. 13: Display of selected features in protein profiles plot. 
...
<p> Fig. 14: Display of selected features in protein profiles plot. 
...
<div align="center">
<img src="figures/Screenshot_PCA6.png" width="100%" alt="" />
<p> Fig. 15: Query for proteins which contain the string "AC" which 
